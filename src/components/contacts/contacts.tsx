...
import { setContactsFalse } from '../../store/reducers/contactsSlice'
import { useAppDispatch, useAppSelector } from '../../store/hooks/redux'

export default function Contacts() {
  const { isOpen } = useAppSelector((state) => state.contacts)
  ...
  return (
    <CSSTransition
      ...
      unmountOnExit
    >
      <div className={cl.bg} onClick={() => dispatch(setContactsFalse())}>
        <CSSTransition
          in={isOpen}
          timeout={500}
          classNames='contacts'
          ...
          >
            <div className={cl.head}>
              ...
              <span
                ...
                onClick={() => dispatch(setContactsFalse())}
              />
            </div>
            <div className={cl.items}>
              <p>
                <svg
                  ...
                  height='32px'
                  width='32px'
                  viewBox='0 0 72.333 72.333'
                >
                  <path d='M63.167,0h-10h-40c-6.065,0-11,4.935-11,11v50.333c0,6.065,4.935,11,11,11h40h10c3.859,0,7-3.141,7-7V7 C70.167,3.14,67.027,0,63.167,0z M13.167,66.333c-2.757,0-5-2.243-5-5V11c0-2.757,2.243-5,5-5h40c0.552,0,1,0.449,1,1v58.333 c0,0.552-0.448,1-1,1H13.167z M64.167,65.333c0,0.552-0.448,1-1,1h-3.08c0.047-0.327,0.08-0.659,0.08-1V7 c0-0.34-0.032-0.672-0.08-1h3.08c0.552,0,1,0.449,1,1V65.333z'></path>{' '}
              ...
              <p>
                ...
                m-millutin@hotmail.com / m-milutin@mail.ru
              </p>
              <p>
                <svg
                  fill='#ffffff'
                  height='32px'
                  width='32px'
                  viewBox='0 0 69.606 69.606'
                >
                  <path d='M34.803,0C15.613,0,0,15.612,0,34.802s15.612,34.804,34.803,34.804s34.803-15.613,34.803-34.804 C69.606,15.612,53.993,0,34.803,0z M34.803,63.606C18.921,63.606,6,50.685,6,34.802C6,18.921,18.921,6,34.803,6 s28.803,12.92,28.803,28.802C63.606,50.685,50.685,63.606,34.803,63.606z'></path>{' '}
                ...
                Шоу рум, 115419, Россия, г. Москва, ул. Орджоникидзе, д.11 стр.3
              </p>
              <p>
